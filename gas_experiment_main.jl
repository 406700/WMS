...
# det_data_path="data/20250109/2khz_20.mat"
# ld_data_path="data/20250109/2khz_20.txt"

# det_data_path="data/20250109/2khz_20_loss.mat"
# ld_data_path="data/20250109/2khz_20_loss.txt"
...
if calculate_Lprime_over_L==true
    for i in keys(ref_chan_dict)
        ...
        println("time=$(L_time_axis[i][end])")
